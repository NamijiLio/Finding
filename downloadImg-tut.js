...
// 爬所有圖片網址
//source:https://ck101.com/thread-5144405-1-1.html
;(async () => {
    ...
    await page.goto('https://mannco.store/?a=&b=&c=&d=&e=&f=DESC&g=&h=4&j=1', {
    ...
    let imageLink = await page.evaluate(() => {
        ...
        return images.map(img => img.src).filter(imgText => imgText.includes('steamcommunity'))
